...
// contract token : 0x222554b0e23Fac3637A147E79FA633dE372D965d
// proxy address : 0x222554b0e23Fac3637A147E79FA633dE372D965d
...
//Link Polygon // cast send 0x0Fd9e8d3aF1aaee056EB9e802c3A762a667b1904 "transfer(address,uint256)" 0x222554b0e23Fac3637A147E79FA633dE372D965d 2000000000000000000 --rpc-url $env:RPC_POLYGON --private-key $env:PRIVATE_KEY
//cast send 0x222554b0e23Fac3637A147E79FA633dE372D965d "modifyContractReceiver(address)" 0x5218985bC1751F533Fd9cD91C4aa72002d6453f5 --rpc-url $env:RPC_POLYGON --private-key $env:PRIVATE_KEY
//cast send 0x222554b0e23Fac3637A147E79FA633dE372D965d "modifyDestinationChainSelector(uint64)" 16015286601757825753 --rpc-url $env:RPC_POLYGON --private-key $env:PRIVATE_KEY
//cast send 0x222554b0e23Fac3637A147E79FA633dE372D965d "addToPaymentQueue(uint256)" 321123 --value 1 --rpc-url $env:RPC_POLYGON --private-key $env:PRIVATE_KEY
//cast call 0x222554b0e23Fac3637A147E79FA633dE372D965d "getReceiverContract()" --rpc-url $env:RPC_POLYGON --private-key $env:PRIVATE_KEY
